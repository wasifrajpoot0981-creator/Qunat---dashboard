...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="Ultimate Quant Whale Ecosystem & Institutional Dashboard",
    page_icon="⚡",
    layout="wide"
)
...
# ==========================================
# MAIN APP LAYOUT (UNIFIED ON A SINGLE PAGE)
# ==========================================
st.title("⚡ Ultimate Quant Whale Ecosystem & Institutional Dashboard")
st.markdown("Yeh raha aap ka mukammal aur unified dashboard jahan saari institutional flows, trade durations (**Kab Tak**), aur real-time Top 50 Whale Sniper signals aik hi page par mojood hain!")

st.sidebar.title("⚡ System Control")
st.sidebar.info("Status: **ONLINE 🟢** | Auto-Refresh: **Every 1 Minute**")

# --- SECTION 1: TOP 50 QUANT WHALE SNIPER ---
st.header("🚀 Top 50 Quant Whale Sniper Master Signal")
...
if st.session_state.current_signal:
    ...
    if sig['Type'] == 'LONG':
        st.success(
            ...
            f"* **Micro-Price ($P_{{micro}}$):** `${sig['Micro Price']:,.4f}` | **Phi ($\Phi$):** `{sig['Phi_Score']}`\n"
...
# --- SECTION 2: INSTITUTIONAL FLOWS & TIME HORIZON ---
st.header("🌊 Institutional Flows & Expected Trade Horizon ('Kab Tak')")
st.markdown("Real-time tracking of Wintermute, Jump Trading, DWF Labs, Amber Group, and Cumberland with duration metrics.")
...
# --- 1 MINUTE (60 SECONDS) AUTO-REFRESH TIMER FOR NEW SIGNALS ---
time.sleep(60)
st.rerun()
