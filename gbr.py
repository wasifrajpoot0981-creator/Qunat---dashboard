...
st.title("MEXC Multi-Coin 1M High-Wall Momentum Engine — Balanced Setup")
...
# --- LOAF (LARGE ORDER IMBALANCE) FORMULA (Low Threshold for easy capturing) ---
...
if bids_df is not None and asks_df is not None and df_1m is not None:
    ...
    st.caption(f"🟢 **Live Server Timestamp:** {current_live_time} | **Mode:** Low Threshold / Active Capture")
    ...
    # Low/Relaxed Conditions so it catches moves easily
